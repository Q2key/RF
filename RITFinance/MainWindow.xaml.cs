...
namespace RITFinance
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            ListViewMain.ItemsSource = UiСontroller.GetAssetsCollection();
        }
        ...
        private void ExecuteEditMenu() 
        {
            ...
            if (a.Type == @"Недвижимость")
            {
                ...
                {
                    if (
                        UiСontroller.StringCheker(editwindow.TextBoxMeterialInitialEstateBalanceСostE.Text) == ""
                        || UiСontroller.StringCheker(editwindow.TextBoxMeterialEstimatedEstateCostE.Text) == ""
                        || UiСontroller.StringCheker(editwindow.TextBoxMeterialFinalEstateBalanceCostE.Text) == ""
                        )
                    {
                        MessageBox.Show("Заполните поля со звездочками");
                        ExecuteEditMenu();
        ...
        private void DeleteAsset()
        {
            ...
            var selected = ListViewMain.SelectedIndex;
            var assets = UiСontroller.GetAssetsCollection();
        ...
        private void ButonEdit_OnClick(object sender, RoutedEventArgs e)
        {
            ExecuteEditMenu();
        }
    }
